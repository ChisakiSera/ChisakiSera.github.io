...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::get('/suggested', [HomeController::class, 'suggestedUsers'])->name('suggested');
    ...
    # PASSWORD
    Route::get('/password/{id}/edit', [ProfileController::class, 'editPassword'])->name('password.edit');
